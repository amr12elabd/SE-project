...
async function seed() {
  ...
  // ── GUESTS ──
  const guestData = [
    // ── Event 1: Cairo Autumn Brew Café ── (25 guests, diverse profiles)
    { guestName: 'Yasmin Ibrahim', email: 'guest@popeyez.com', phone: '+20 108 901 2345', event: event1._id, group: 'VIP', rsvpStatus: 'Attending', dietaryPreferences: ['Vegan'], allergies: ['Nuts'], specialRequirements: 'Wheelchair accessible seating needed', qrCodeValue: 'QR-YASMIN-001', checkInStatus: true, checkedInAt: new Date('2026-07-15T12:05:00'), checkedInBy: staff2._id },
    ...
    { guestName: 'Mariam Fathy', email: 'mariam.fathy@email.com', phone: '+20 100 333 4455', event: event1._id, group: 'Press', rsvpStatus: 'Attending', dietaryPreferences: ['Gluten Free'], allergies: ['Gluten'], specialRequirements: 'Media kit required, plus front-row seating for photography', qrCodeValue: 'QR-MARIAM-003', checkInStatus: true, checkedInAt: new Date('2026-07-15T12:30:00'), checkedInBy: staff2._id },
    { guestName: 'Tarek Abdallah', email: 'tarek.abdallah@email.com', phone: '+20 112 445 6677', event: event1._id, group: 'General', rsvpStatus: 'Attending', dietaryPreferences: ['Vegetarian'], qrCodeValue: 'QR-TAREK-004', checkInStatus: true, checkedInAt: new Date('2026-07-15T12:40:00'), checkedInBy: staff1._id },
    { guestName: 'Dina Mostafa', email: 'dina.mostafa@email.com', event: event1._id, group: 'VIP', rsvpStatus: 'Not Attending', specialRequirements: 'Will attend the next event — please keep on mailing list', qrCodeValue: 'QR-DINA-005', checkInStatus: false },
    { guestName: 'Hossam Rashid', email: 'hossam.rashid@email.com', phone: '+20 115 667 8899', event: event1._id, group: 'General', rsvpStatus: 'Attending', qrCodeValue: 'QR-HOSSAM-006', checkInStatus: true, checkedInAt: new Date('2026-07-15T12:55:00'), checkedInBy: staff1._id },
    ...
    { guestName: 'Karim Samir', email: 'karim.samir@email.com', event: event1._id, group: 'Press', rsvpStatus: 'Attending', specialRequirements: 'Needs a power outlet nearby for laptop', qrCodeValue: 'QR-KARIM-008', checkInStatus: true, checkedInAt: new Date('2026-07-15T13:10:00'), checkedInBy: staff2._id },
    { guestName: 'Noura Atef', email: 'noura.atef@email.com', phone: '+20 111 222 3344', event: event1._id, group: 'VIP', rsvpStatus: 'Attending', dietaryPreferences: ['Vegan', 'Gluten Free'], allergies: ['Dairy', 'Gluten'], qrCodeValue: 'QR-NOURA-009', checkInStatus: true, checkedInAt: new Date('2026-07-15T12:50:00'), checkedInBy: staff2._id },
    { guestName: 'Bassel Younis', email: 'bassel.younis@email.com', event: event1._id, group: 'General', rsvpStatus: 'Attending', qrCodeValue: 'QR-BASSEL-010', checkInStatus: false },
    { guestName: 'Mona El Sayed', email: 'mona.elsayed@email.com', phone: '+20 106 112 2334', event: event1._id, group: 'General', rsvpStatus: 'Attending', qrCodeValue: 'QR-MONA-011', checkInStatus: true, checkedInAt: new Date('2026-07-15T13:20:00'), checkedInBy: staff1._id },
    { guestName: 'Sherif Gamal', email: 'sherif.gamal@email.com', event: event1._id, group: 'Press', rsvpStatus: 'Attending', specialRequirements: 'Photography pass needed — shooting for CairoLife Magazine', qrCodeValue: 'QR-SHERIF-012', checkInStatus: true, checkedInAt: new Date('2026-07-15T12:00:00'), checkedInBy: staff2._id },
    { guestName: 'Laila Hassan', email: 'laila.hassan@email.com', phone: '+20 100 889 9001', event: event1._id, group: 'VIP', rsvpStatus: 'Attending', dietaryPreferences: ['Halal'], qrCodeValue: 'QR-LAILA-013', checkInStatus: true, checkedInAt: new Date('2026-07-15T13:30:00'), checkedInBy: staff2._id },
    { guestName: 'Ahmed Fouad', email: 'ahmed.fouad@email.com', event: event1._id, group: 'General', rsvpStatus: 'Attending', qrCodeValue: 'QR-AHMEDF-014', checkInStatus: false },
    { guestName: 'Nadia Ramzy', email: 'nadia.ramzy@email.com', phone: '+20 101 234 5670', event: event1._id, group: 'General', rsvpStatus: 'Attending', dietaryPreferences: ['Vegetarian', 'Dairy Free'], qrCodeValue: 'QR-NADIA-015', checkInStatus: false },
    { guestName: 'Khaled Amin', email: 'khaled.amin@email.com', event: event1._id, group: 'General', rsvpStatus: 'Maybe', specialRequirements: 'Will confirm 2 days before', qrCodeValue: 'QR-KHAMIN-016', checkInStatus: false },
    { guestName: 'Ines Farid', email: 'ines.farid@email.com', phone: '+20 102 345 6781', event: event1._id, group: 'VIP', rsvpStatus: 'Attending', qrCodeValue: 'QR-INES-017', checkInStatus: true, checkedInAt: new Date('2026-07-15T13:45:00'), checkedInBy: staff1._id },
    { guestName: 'Mahmoud Salah', email: 'mahmoud.salah@email.com', event: event1._id, group: 'General', rsvpStatus: 'Not Attending', specialRequirements: 'Out of country in July', qrCodeValue: 'QR-MSALAH-018', checkInStatus: false },
    { guestName: 'Camilia Iskander', email: 'camilia.iskander@email.com', phone: '+20 103 456 7892', event: event1._id, group: 'Press', rsvpStatus: 'Attending', specialRequirements: 'Will be doing a live social media stream — needs fast WiFi', qrCodeValue: 'QR-CAMILIA-019', checkInStatus: true, checkedInAt: new Date('2026-07-15T14:00:00'), checkedInBy: staff2._id },
    { guestName: 'Youssef Nour', email: 'youssef.nour@email.com', event: event1._id, group: 'General', rsvpStatus: 'Attending', dietaryPreferences: ['Vegan'], qrCodeValue: 'QR-YNOUR-020', checkInStatus: false },
    { guestName: 'Sandra Milad', email: 'sandra.milad@email.com', phone: '+20 104 567 8903', event: event1._id, group: 'VIP', rsvpStatus: 'Attending', dietaryPreferences: ['Kosher'], qrCodeValue: 'QR-SANDRA-021', checkInStatus: false },
    { guestName: 'Bishoy Nassif', email: 'bishoy.nassif@email.com', event: event1._id, group: 'General', rsvpStatus: 'Attending', qrCodeValue: 'QR-BISHOY-022', checkInStatus: true, checkedInAt: new Date('2026-07-15T14:10:00'), checkedInBy: staff1._id },
    { guestName: 'Hana Zaki', email: 'hana.zaki@email.com', phone: '+20 105 678 9014', event: event1._id, group: 'General', rsvpStatus: 'Attending', dietaryPreferences: ['No Nuts'], allergies: ['Tree Nuts'], qrCodeValue: 'QR-HZAKI-023', checkInStatus: false },
    { guestName: 'Shady Peter', email: 'shady@popeyez.com', phone: '+20 109 777 8899', event: event1._id, group: 'VIP', rsvpStatus: 'Attending', qrCodeValue: 'QR-SHADY-024', checkInStatus: true, checkedInAt: new Date('2026-07-15T13:00:00'), checkedInBy: staff2._id },

    // ── Event 2: Maadi Sunset Espresso Night ── (8 guests)
    { guestName: 'Salma Wael', email: 'salma.wael@email.com', phone: '+20 100 112 2234', event: event2._id, group: 'VIP', rsvpStatus: 'Attending', specialRequirements: 'Table for two — bringing business partner', qrCodeValue: 'QR-SALMA-025', checkInStatus: false },
    { guestName: 'Adam Hosny', email: 'adam.hosny@email.com', event: event2._id, group: 'General', rsvpStatus: 'Maybe', specialRequirements: 'Depends on work schedule', qrCodeValue: 'QR-ADAM-026', checkInStatus: false },
    { guestName: 'Rana Farouk', email: 'rana.farouk@email.com', phone: '+20 101 223 3345', event: event2._id, group: 'General', rsvpStatus: 'Attending', dietaryPreferences: ['Vegetarian'], qrCodeValue: 'QR-RANA-027', checkInStatus: false },
    { guestName: 'Hassan Tawfik', email: 'hassan.tawfik@email.com', event: event2._id, group: 'VIP', rsvpStatus: 'Not Attending', specialRequirements: 'Travelling — please invite to next event', qrCodeValue: 'QR-HASSAN-028', checkInStatus: false },
    { guestName: 'Mirna George', email: 'mirna.george@email.com', phone: '+20 102 334 4456', event: event2._id, group: 'General', rsvpStatus: 'Attending', dietaryPreferences: ['Dairy Free'], qrCodeValue: 'QR-MIRNA-029', checkInStatus: false },
    { guestName: 'Tarek Wahba', email: 'tarek.wahba@email.com', event: event2._id, group: 'VIP', rsvpStatus: 'Attending', qrCodeValue: 'QR-TWAHBA-030', checkInStatus: false },
    { guestName: 'Riham Saad', email: 'riham.saad@email.com', event: event2._id, group: 'General', rsvpStatus: 'Attending', dietaryPreferences: ['Vegan'], qrCodeValue: 'QR-RIHAM-031', checkInStatus: false },
    { guestName: 'Fares El Nile', email: 'fares.elnile@email.com', phone: '+20 103 445 5567', event: event2._id, group: 'Press', rsvpStatus: 'Attending', specialRequirements: 'Event blogger — needs access to behind-the-scenes', qrCodeValue: 'QR-FARES-032', checkInStatus: false },

    // ── Event 3: Heliopolis Coffee & Art Fair ── (8 guests)
    { guestName: 'Leila Zaki', email: 'leila.zaki@email.com', phone: '+20 104 556 6678', event: event3._id, group: 'Press', rsvpStatus: 'Attending', specialRequirements: 'Art critic — needs advance programme', qrCodeValue: 'QR-LEILA-033', checkInStatus: false },
    { guestName: 'Fady Naguib', email: 'fady.naguib@email.com', event: event3._id, group: 'General', rsvpStatus: 'Attending', dietaryPreferences: ['Vegetarian'], qrCodeValue: 'QR-FADY-034', checkInStatus: false },
    { guestName: 'Sarah Maher', email: 'sarah.maher@email.com', phone: '+20 105 667 7789', event: event3._id, group: 'VIP', rsvpStatus: 'Attending', dietaryPreferences: ['Vegan'], specialRequirements: 'Gallery partner — exhibiting artwork at the event', qrCodeValue: 'QR-SARAH-035', checkInStatus: false },
    { guestName: 'Adel Kamal', email: 'adel.kamal@email.com', event: event3._id, group: 'General', rsvpStatus: 'Attending', qrCodeValue: 'QR-ADEL-036', checkInStatus: false },
    { guestName: 'Lina Nabil', email: 'lina.nabil@email.com', phone: '+20 106 778 8890', event: event3._id, group: 'General', rsvpStatus: 'Attending', dietaryPreferences: ['Gluten Free'], qrCodeValue: 'QR-LINA-037', checkInStatus: false },
    { guestName: 'Maged Samir', email: 'maged.samir@email.com', event: event3._id, group: 'VIP', rsvpStatus: 'Maybe', qrCodeValue: 'QR-MAGED-038', checkInStatus: false },
    { guestName: 'Shady Peter', email: 'shady@popeyez.com', phone: '+20 109 777 8899', event: event3._id, group: 'Press', rsvpStatus: 'Attending', specialRequirements: 'Covering for Egypt Art & Culture Weekly', qrCodeValue: 'QR-SHADY-039', checkInStatus: false },
    { guestName: 'Ranya Hassan', email: 'ranya.hassan@email.com', phone: '+20 107 889 9001', event: event3._id, group: 'General', rsvpStatus: 'Attending', qrCodeValue: 'QR-RANYA-040', checkInStatus: false },

    // ── Event 4: Dokki Brew Workshop ── (6 guests — completed event, all checked in)
    { guestName: 'Amira Soliman', email: 'amira.soliman@email.com', phone: '+20 108 001 1123', event: event4._id, group: 'General', rsvpStatus: 'Attending', dietaryPreferences: ['Vegan'], qrCodeValue: 'QR-AMIRA-041', checkInStatus: true, checkedInAt: new Date('2026-06-10T15:05:00'), checkedInBy: staff2._id },
    { guestName: 'Wael Ibrahim', email: 'wael.ibrahim@email.com', event: event4._id, group: 'General', rsvpStatus: 'Attending', qrCodeValue: 'QR-WAEL-042', checkInStatus: true, checkedInAt: new Date('2026-06-10T15:10:00'), checkedInBy: staff2._id },
    { guestName: 'Doaa Ramadan', email: 'doaa.ramadan@email.com', event: event4._id, group: 'General', rsvpStatus: 'Not Attending', specialRequirements: 'Cancelled last minute — illness', qrCodeValue: 'QR-DOAA-043', checkInStatus: false },
    { guestName: 'Kareem Bishara', email: 'kareem.bishara@email.com', phone: '+20 109 112 2234', event: event4._id, group: 'General', rsvpStatus: 'Attending', dietaryPreferences: ['Gluten Free'], qrCodeValue: 'QR-KBISHARA-044', checkInStatus: true, checkedInAt: new Date('2026-06-10T15:15:00'), checkedInBy: staff2._id },
    { guestName: 'Dina Wahdan', email: 'dina.wahdan@email.com', event: event4._id, group: 'General', rsvpStatus: 'Attending', dietaryPreferences: ['Dairy Free'], qrCodeValue: 'QR-DWAHDAN-045', checkInStatus: true, checkedInAt: new Date('2026-06-10T15:20:00'), checkedInBy: staff2._id },
    { guestName: 'Nour Eldin Farouk', email: 'nour.farouk@email.com', phone: '+20 100 223 3345', event: event4._id, group: 'General', rsvpStatus: 'Attending', qrCodeValue: 'QR-NFAROUK-046', checkInStatus: true, checkedInAt: new Date('2026-06-10T15:00:00'), checkedInBy: staff2._id },

    // ── Event 5: Zamalek Winter Rooftop ── (5 guests, early planning)
    { guestName: 'Dina Khoury', email: 'dina.khoury@email.com', event: event5._id, group: 'VIP', rsvpStatus: 'Attending', specialRequirements: 'Prefers indoor seating if available', qrCodeValue: 'QR-DKHOURY-047', checkInStatus: false },
    { guestName: 'Sami Youssef', email: 'sami.youssef@email.com', phone: '+20 101 334 4456', event: event5._id, group: 'General', rsvpStatus: 'Attending', qrCodeValue: 'QR-SYOUSSEF-048', checkInStatus: false },
    { guestName: 'Heba Rabie', email: 'heba.rabie@email.com', event: event5._id, group: 'General', rsvpStatus: 'Maybe', qrCodeValue: 'QR-HRABIE-049', checkInStatus: false },
    { guestName: 'Yasmin Ibrahim', email: 'guest@popeyez.com', phone: '+20 108 901 2345', event: event5._id, group: 'VIP', rsvpStatus: 'Attending', dietaryPreferences: ['Vegan'], qrCodeValue: 'QR-YASMIN5-050', checkInStatus: false },
    { guestName: 'Omar Khalifa', email: 'omar.khalifa@email.com', phone: '+20 102 445 5567', event: event5._id, group: 'Press', rsvpStatus: 'Attending', specialRequirements: 'Winter edition feature for Ahram newspaper', qrCodeValue: 'QR-OKHALIFA-051', checkInStatus: false },
  ];
  ...
  const event3Guests = guests.filter(g => g.event.toString() === event3._id.toString());
  const event4Guests = guests.filter(g => g.event.toString() === event4._id.toString());

  const comm1 = await Communication.create({ event: event1._id, sentBy: organizer._id, message: '🎉 Cairo Autumn Brew Café is officially CONFIRMED for July 15th at Zamalek Garden Terrace! Doors open at 12:00 PM. We have an incredible day planned — artisan coffee, live jazz, seasonal pastries and the most beautiful rooftop in Zamalek. We cannot wait to see you!', recipients: event1Guests.map(g => g._id), receivedBy: event1Guests.map(g => g._id), seenBy: event1Guests.slice(0, 18).map(g => g._id) });
  await Communication.create({ event: event1._id, sentBy: organizer._id, message: '☕ What to expect at Cairo Autumn Brew Café:\n\n• Single-origin pour-overs from Ethiopia, Colombia & Yemen\n• Seasonal espresso specialties (Pumpkin Spice Latte, Salted Caramel Macchiato)\n• Artisan pastries from Atwa\'s Bakery\n• Live jazz by the Nile Jazz Trio (starts 1 PM)\n• Evening DJ set from 8 PM\n\nVegan and gluten-free options available throughout. See you Saturday! 🍂', recipients: event1Guests.map(g => g._id), receivedBy: event1Guests.map(g => g._id), seenBy: event1Guests.slice(0, 15).map(g => g._id) });
  await Communication.create({ event: event1._id, sentBy: organizer._id, message: '⏰ EVENT TOMORROW — Final reminder!\n\nJuly 15th | 12:00 PM–10:00 PM\nZamalek Garden Terrace, 15 Hassan Sabry St\n\n✅ Bring your QR code (check your email or app)\n✅ Smart casual dress code\n✅ Arrive 15 minutes early to avoid check-in queue\n\nWe look forward to welcoming you! 🎊', recipients: event1Guests.map(g => g._id), receivedBy: event1Guests.slice(0, 20).map(g => g._id), seenBy: event1Guests.slice(0, 12).map(g => g._id) });
  const comm4 = await Communication.create({ event: event1._id, sentBy: organizer._id, message: '📍 PARKING UPDATE: Use the north entrance on Hassan Sabry St — it\'s clearly marked with PopEyez signage. Free parking is available for all event guests in Lot B. Valet is also available at the main entrance for an additional 50 EGP.', recipients: event1Guests.slice(0, 10).map(g => g._id), receivedBy: event1Guests.slice(0, 10).map(g => g._id), seenBy: [], isFollowUp: true, followUpTo: comm1._id });
  await Communication.create({ event: event1._id, sentBy: organizer._id, message: '📸 Thank you for attending Cairo Autumn Brew Café! We hope you had an unforgettable experience. Event photos will be available on our Instagram @popeyezcafe within 48 hours. Please tag us in your stories and use #PopEyezCairo — we\'d love to feature you! See you at the next event 🌟', recipients: event1Guests.filter(g => g.checkInStatus).map(g => g._id), receivedBy: event1Guests.filter(g => g.checkInStatus).map(g => g._id), seenBy: event1Guests.filter(g => g.checkInStatus).slice(0, 8).map(g => g._id) });

  await Communication.create({ event: event2._id, sentBy: organizer._id, message: '✨ Maadi Sunset Espresso Night — SAVE THE DATE!\n\nAugust 20th, 2026 | 5:00 PM – 11:00 PM\nMaadi Riverside Loft, 7 Road 9, Maadi\n\nAn intimate evening of specialty espresso, gourmet bites and a live DJ set with Nile views. Cocktail dress code. Limited spots — tickets available soon.', recipients: event2Guests.map(g => g._id), receivedBy: event2Guests.map(g => g._id), seenBy: event2Guests.slice(0, 4).map(g => g._id) });
  await Communication.create({ event: event2._id, sentBy: organizer._id, message: '☕ Exclusive sneak peek: The Maadi Sunset Espresso Night will feature a 45-minute Espresso Master Class led by our head barista Nour El-Din — learn the science behind the perfect shot. Spaces limited to 12 per session. Confirm your RSVP to reserve your spot!', recipients: event2Guests.map(g => g._id), receivedBy: event2Guests.slice(0, 6).map(g => g._id), seenBy: event2Guests.slice(0, 3).map(g => g._id) });

  await Communication.create({ event: event3._id, sentBy: organizer2._id, message: '🎨☕ Heliopolis Coffee & Art Fair — Registration Now Open!\n\nSeptember 5th | 10:00 AM – 9:00 PM\nHeliopolis Creative Warehouse\n\nJoin us for Cairo\'s biggest specialty coffee and contemporary art event. 15 local artists, live roasting demos, 4 workshops, and coffee from 8 origins. This is a milestone event — do not miss it.', recipients: event3Guests.map(g => g._id), receivedBy: event3Guests.map(g => g._id), seenBy: event3Guests.slice(0, 5).map(g => g._id) });

  await Communication.create({ event: event4._id, sentBy: organizer2._id, message: '☕ Brew Workshop Preparation Guide:\n\nPlease arrive by 2:45 PM for setup. The studio will have 6 brewing stations (V60, Chemex, AeroPress). We provide all equipment and coffee — just bring your curiosity!\n\nDress casually and comfortably. Duration: approx. 4 hours including breaks and tasting. See you Saturday!', recipients: event4Guests.map(g => g._id), receivedBy: event4Guests.map(g => g._id), seenBy: event4Guests.slice(0, 5).map(g => g._id) });

  console.log('Communications created.');

  // ── FEEDBACK ──
  // Event 1 feedback (10 responses from diverse guests)
  await Feedback.create({ event: event1._id, guest: guests[0]._id, overallRating: 5, foodRating: 5, venueRating: 5, organizationRating: 5, comments: 'Absolutely phenomenal! The Ethiopian single-origin pour-over was the best coffee I\'ve had in Cairo. The Zamalek terrace was breathtaking with autumn flowers everywhere. Sara and her team are true professionals — every detail was perfect. I already signed up for the next event.' });
  await Feedback.create({ event: event1._id, guest: guests[1]._id, overallRating: 4, foodRating: 4, venueRating: 5, organizationRating: 4, comments: 'Really enjoyable afternoon. The pastries from Atwa\'s Bakery were excellent — the caramel apple croissants were a highlight. Staff were warm and attentive. The only improvement I\'d suggest is a faster check-in process; waited about 8 minutes in queue.' });
  await Feedback.create({ event: event1._id, guest: guests[2]._id, overallRating: 5, foodRating: 5, venueRating: 4, organizationRating: 5, comments: 'Covering this event for Cairo Culture Times was a pleasure. The branding was cohesive, the press corner was well-equipped, and the organizer was proactive with media kits. The autumn color palette throughout the venue was stunning. Five stars — a benchmark for Cairo pop-up events.' });
  await Feedback.create({ event: event1._id, guest: guests[5]._id, overallRating: 3, foodRating: 3, venueRating: 4, organizationRating: 3, comments: 'The venue was genuinely beautiful and the concept is great. However, wait times for coffee reached 20+ minutes at peak hours and the food ran low by 3 PM. The event needs more barista stations and better stock management. I\'d try again if these issues are addressed.' });
  await Feedback.create({ event: event1._id, guest: guests[8]._id, overallRating: 5, foodRating: 4, venueRating: 5, organizationRating: 5, comments: 'The autumn theme was executed brilliantly — from the hanging floral installations to the pumpkin-spice menu. As a vegan, I appreciated the clearly labelled dairy-free options. The live jazz trio added the perfect ambiance. Already planning to bring 6 friends next time!' });
  await Feedback.create({ event: event1._id, guest: guests[3]._id, overallRating: 4, foodRating: 5, venueRating: 4, organizationRating: 4, comments: 'The vegetarian menu options were excellent — much better than I expected. The mini sandwiches and custom cakes were genuinely delicious. Sound system was a bit loud at times making conversation difficult, but overall a very well-organized event.' });
  await Feedback.create({ event: event1._id, guest: guests[6]._id, overallRating: 4, foodRating: 4, venueRating: 5, organizationRating: 4, comments: 'Loved the rooftop setting with Nile views. The dairy-free coffee options were clearly marked and tasted great. Staff were helpful. Parking was a bit tricky despite the directions. Would definitely attend again — great experience for Cairo.' });
  await Feedback.create({ event: event1._id, guest: guests[10]._id, overallRating: 5, foodRating: 5, venueRating: 5, organizationRating: 5, comments: 'One of the best events I\'ve attended in Cairo this year. Every aspect was thoughtfully planned — the layout, the menu, the entertainment, and the staff. The QR check-in was smooth and modern. The evening DJ set was a lovely surprise. Full marks!' });
  await Feedback.create({ event: event1._id, guest: guests[11]._id, overallRating: 4, foodRating: 3, venueRating: 5, organizationRating: 5, comments: 'As press, I was impressed by the level of organization and the communications team. The event ran exactly on schedule, which is rare. Food could be more varied — too many pastries, not enough savoury options. Overall a professional and well-executed event worth covering.' });
  await Feedback.create({ event: event1._id, guest: guests[23]._id, overallRating: 5, foodRating: 5, venueRating: 5, organizationRating: 5, comments: 'Outstanding event from start to finish! The VIP treatment was exceptional — dedicated seating area, priority service, and complimentary tasting flight. The autumn aesthetic was perfectly curated. I run a food blog and this will definitely be featured as Cairo\'s top pop-up of 2026.' });

  // Event 4 feedback (workshop — 4 detailed responses)
  await Feedback.create({ event: event4._id, guest: guests[41]._id, overallRating: 5, foodRating: 5, venueRating: 4, organizationRating: 5, comments: 'The V60 session completely changed how I make coffee at home. Nour\'s instruction was clear, patient, and deeply knowledgeable. The single-origin tasting was a revelation — the Yemeni bean was extraordinary. This workshop is worth every pound. Please offer a Level 2 session!' });
  await Feedback.create({ event: event4._id, guest: guests[42]._id, overallRating: 4, foodRating: 5, venueRating: 4, organizationRating: 4, comments: 'Really informative and the coffees we tasted were outstanding — especially the Colombian washed process. The Chemex session was my favourite. I\'d love a longer workshop (3 hours instead of 2) to go deeper into each method. Would recommend to any coffee enthusiast.' });
  await Feedback.create({ event: event4._id, guest: guests[44]._id, overallRating: 5, foodRating: 4, venueRating: 5, organizationRating: 5, comments: 'Exceptional hands-on experience. The brewing stations were well-equipped and the ratios were explained clearly with printed reference cards to take home. The Dokki Art Studio was a perfect intimate setting. Already booked my next PopEyez event. Thank you!' });
  await Feedback.create({ event: event4._id, guest: guests[45]._id, overallRating: 5, foodRating: 5, venueRating: 4, organizationRating: 5, comments: 'I came as a complete beginner and left as a confident home brewer. The AeroPress session was the most surprising — so versatile! The instructor was excellent at explaining the science behind each method without being overwhelming. Best 200 EGP I\'ve spent this year.' });
