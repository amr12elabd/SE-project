...
const { getEvents, createEvent, getEvent, updateEvent, deleteEvent, getEventDashboard, updateEventStatus, duplicateEvent } = require('../controllers/eventController');
...
router.post('/:id/duplicate', authorize('organizer'), duplicateEvent);
